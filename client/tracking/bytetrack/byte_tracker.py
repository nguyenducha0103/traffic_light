...
class STrack(BaseTrack):
    ...
    def __repr__(self):
        return 'OT_{}_({}-{})_{}'.format(self.track_id, self.start_frame, self.end_frame, self.cls)


class BYTETracker(object):
    def __init__(self, track_thresh=0.4, track_buffer=40, match_thresh=0.7, min_box_area=10, frame_rate=30):
    ...
    def update(self, bboxes, scores, classes):
        ...
        if len(dets_second) > 0:
            ...
            detections_second = [STrack(STrack.tlbr_to_tlwh(tlbr), s,cls) for
                                 (tlbr, s,cls) in zip(dets_second, scores_second,classes)]
